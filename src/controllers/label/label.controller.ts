...
export class LabelController {
  ...
  @Post()
  async create(
    @Body(new ValidationPipe({ transform: true })) request: CreateLabelDto,
  ): Promise<Label> {
  ...
  @Put()
  async update(
    @Body(new ValidationPipe({ transform: true })) request: UpdateLabelDto,
  ): Promise<Label> {
  ...
  @Delete()
  async delete(
    @Body(new ValidationPipe({ transform: true })) request: DeleteLabelDto,
  ): Promise<Label> {
